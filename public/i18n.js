...
// BUGFIX (2026-08-22): this used to be "bn" — so any new user who hadn't
// picked a language yet (me.language undefined, e.g. during First Time
// Profile Setup / ID creation) got the whole flow shown in Bengali by
// default (see applyLanguage() below: an undefined lang falls back to
// I18N_DEFAULT). Per request, English is now the default everywhere;
// users can still switch languages from the same dropdown as before.
