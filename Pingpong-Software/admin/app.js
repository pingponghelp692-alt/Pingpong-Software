...
function renderUsersTable() {
  ...
  filtered.forEach((u) => {
    ...
    tr.innerHTML = `
      ...
      <td>${countryCell}</td>
      <td class="mono"><img src="/images/icons/icon-coin.png" class="currency-icon" alt="coin"> ${u.coins}</td>
...
async function loadGiftManager() {
  ...
  r.gifts.forEach((g) => {
    ...
    row.innerHTML = `
      ...
      <div class="data-row-main"><b>${escapeHtml(g.name)}</b><span class="sub">${g.price.toLocaleString()} <img src="/images/icons/icon-coin.png" class="currency-icon" alt="coin"> · ${GIFT_TIER_LABEL[g.tier] || g.tier} · ${GIFT_EFFECT_LABEL[g.effectType] || g.effectType} ${g.sound ? "· 🔊" : ""} ${g.enabled === false ? "· Off" : ""}</span></div>
...
async function loadVideoGifts() {
  ...
  r.gifts.forEach((g) => {
    ...
    row.innerHTML = `
      ...
      <div class="data-row-main"><b>${escapeHtml(g.name)}</b><span class="sub">${g.price.toLocaleString()} <img src="/images/icons/icon-coin.png" class="currency-icon" alt="coin"> · ${g.duration}s ${g.enabled === false ? "· Off" : ""}</span></div>
